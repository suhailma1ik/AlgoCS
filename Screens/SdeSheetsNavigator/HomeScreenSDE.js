...
export default function HomeScreenSDE({ navigation }) {
  ...
  const { user, Babbar, Striver, Fraz, Blind75, GFG, AmanDhattarwal } =
    useStore((state) => ({
      user: state.user,
      Babbar: state.Babbar,
              ...
              >
                ...
                >
                  ...
                  <Progress.Bar
                    progress={
                      index === 0
                        ? Babbar / item.problems
                        : index === 1
                        ? Striver / item.problems
                        : index === 2
                        ? Fraz / item.problems
                        : index === 3
                        ? Blind75 / item.problems
                        : index === 4
                        ? GFG / item.problems
                        : AmanDhattarwal / item.problems
                    }
                    width={width * 0.2}
                    color='grey'
                    animated={true}
